...
var Pi = Ve((nt) => {
  ...
  function hi(e, t, r, n, i) {
    ...
    let s = Number((t >> BigInt(32)) & BigInt(4294967295));
    return (
      (e[r + 3] = s), (s = s >> 8), (e[r + 2] = s), (s = s >> 8), (e[r + 1] = s), (s = s >> 8), (e[r] = s), r + 8
    );
  }
...
var er = class {
  ...
  async start() {
    ...
    return (
      (this.libraryStartingPromise = this.tracingHelper.runInChildSpan('connect', t)), this.libraryStartingPromise
    );
  }
  async stop() {
    if (
